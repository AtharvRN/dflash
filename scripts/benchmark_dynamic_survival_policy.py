...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Smoke-test DFlash dynamic survival block policy during decoding.")
...
def main() -> None:
    ...
    for instance in tqdm(dataset, desc="dynamic decode"):
        messages = []
